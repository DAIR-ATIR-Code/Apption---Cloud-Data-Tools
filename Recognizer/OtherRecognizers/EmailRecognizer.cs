...
namespace RecognizerTools
{
    ...
    public class EmailRecognizer : Recognizer, ILetterWithNumberRecognizer, ILongStringRecognizer
    {
        private ColumnMetadata metadata;

        public EmailRecognizer(ColumnMetadata metadata)
        {
        ...
        public override bool IsMatch(string data, CancellationToken cancellationToken)
        {
            ...
            {
                return RegexHelper.EMAIL_PATTERN.IsMatch(data);
            }
            return false;
        }
