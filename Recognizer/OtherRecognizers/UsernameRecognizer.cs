...
namespace RecognizerTools
{
    ...
    public class UsernameRecognizer : Recognizer, ILetterWithNumberRecognizer, IMediumStringRecognizer, ILongStringRecognizer
    {
        private ColumnMetadata metadata;

        public UsernameRecognizer(ColumnMetadata metadata)
        {
        ...
        public override bool IsMatch(string data, CancellationToken cancellationToken)
        {
            ...
            {
                return RegexHelper.USERNAME_PATTERN.IsMatch(data);
            }
            return false;
        }        
