...
namespace RecognizerTools
{
    ...
    public class HTTPRecognizer : Recognizer, ILetterWithNumberRecognizer, ILongStringRecognizer
    {
        private ColumnMetadata metadata;

        public HTTPRecognizer(ColumnMetadata metadata)
        {
        ...
        public override bool IsMatch(string data, CancellationToken cancellationToken)
        {
            ...
            {
                return RegexHelper.HTTP_PATTERN.IsMatch(data);
            }
            return false;
        }
