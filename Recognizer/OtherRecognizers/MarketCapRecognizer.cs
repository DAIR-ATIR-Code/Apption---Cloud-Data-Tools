...
namespace RecognizerTools
{
    ...
    public class MarketCapRecognizer : Recognizer, ILetterWithNumberRecognizer, IMediumStringRecognizer, IShortStringRecognizer
    {
        private ColumnMetadata metadata;

        private const int MAX_LENGTH = 10;
        public MarketCapRecognizer(ColumnMetadata metadata)
        {
        ...
        public override bool IsMatch(string data, CancellationToken cancellationToken)
        {
            ...
            {
                return RegexHelper.MARKETCAP_PATTERN.IsMatch(data);
            }
            return false;
        }
