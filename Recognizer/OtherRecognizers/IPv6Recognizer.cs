...
namespace RecognizerTools
{
    ...
    public class IPv6Recognizer : Recognizer, ILetterWithNumberRecognizer, ILongStringRecognizer
    {
        private ColumnMetadata metadata;

        public IPv6Recognizer(ColumnMetadata metadata)
        {
        ...
        public override bool IsMatch(string data, CancellationToken cancellationToken)
        {
            ...
            {
                return RegexHelper.IPV6_PATTERN.IsMatch(data);
            }
            return false;
        }
