...
namespace RecognizerTools
{
    ...
    public class FirstNameRecognizer : Recognizer, ILetterRecognizer, IMediumStringRecognizer, IShortStringRecognizer, ISensitiveRecognizer
    {
        private ColumnMetadata metadata;
        public FirstNameRecognizer(ColumnMetadata metadata)
        {
        ...
        public override bool IsMatch(string data, CancellationToken cancellationToken)
        {
            ...
            {
                if (ReferenceHelper.ReferenceDic["FirstNames"].Contains(data))
                    return true;
            }
                return false;
        }
